...
CLEANUP mode commits any remaining changes and pushes to the remote. It is the final git phase before reporting. This is the only mode that performs push operations.
