...
```
## Delegation Rules
1. **Delegate WHAT** — describe artifact, objective, criteria. Agents choose approach. 2. **Committer mode** — MODE (PREFLIGHT/CHECKPOINT/CLEANUP) categories dispatch.
3. **Structured templates** — populate ACTION, ARTIFACT, DOMAIN/SCOPE, KDS, RETURN, ACCEPTANCE. 4. **On escalation** — load `escalation-protocol` skill, follow Overseer Response.
## Context Marker
